...
Usage:
    git diff --cached | uv run python scripts/diff_impact.py
    uv run python scripts/diff_impact.py --diff-file /tmp/change.diff
    uv run python scripts/diff_impact.py < /tmp/change.diff
