...
| [`004_usaco`](tutorials/rl/004_usaco/004_usaco.ipynb) | Hill-climb Qwen3.6-35B-A3B on USACO with sandbox-verified rewards | Advanced | `slime` | <a href="https://modal.com/notebooks/new/https://github.com/modal-projects/training-gym/blob/main/tutorials/rl/004_usaco/004_usaco.ipynb" target="_blank" rel="nofollow noopener noreferrer"><img src="https://modal-cdn.com/open-in-modal.svg" alt="Open in Modal"></a> |
