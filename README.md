...
| [`001_toolathlon_privacy`](tutorials/agent/001_toolathlon_privacy/001_toolathlon_privacy.ipynb) | Convert Toolathlon privacy-desensitization tasks to Harbor format, register agent tools, and evaluate Qwen3-8B | Intermediate | Modal Sandbox | <a href="https://modal.com/notebooks/new/https://github.com/modal-projects/training-gym/blob/main/tutorials/agent/001_toolathlon_privacy/001_toolathlon_privacy.ipynb" target="_blank" rel="nofollow noopener noreferrer"><img src="https://modal-cdn.com/open-in-modal.svg" alt="Open in Modal"></a> |
<!-- END TUTORIAL TABLE -->
