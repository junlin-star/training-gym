...
export const TIMING_COLORS = {
  ...
  reward: slot("paired-6"),
  reward_batch: `color-mix(in srgb, ${slot("paired-6")} 55%, white)`,
  reward_post_process: `color-mix(in srgb, ${slot("primary-6")} 60%, white)`,
  train_models: slot("primary-7"),
  compute_log_probs: slot("primary-4"),
  forward_backward: `color-mix(in srgb, ${slot("primary-7")} 55%, white)`,
  optimizer_step: slot("paired-4"),
  weight_sync: slot("primary-5"),
  offload_rollout: slot("paired-8"),
  offload_train: slot("paired-8"),
