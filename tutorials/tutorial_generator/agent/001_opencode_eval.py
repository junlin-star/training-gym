...
"""Tutorial source for `001_opencode_eval` — parsed by generate_tutorial.py."""

TUTORIAL_METADATA = {
    "framework": "Modal Sandbox",
    "cluster_shape": "1 x 1xH100",
    "summary": "Agentic Toolathlon file tasks with sandbox tools and HarborEval scoring",
