...
"""Tutorial source for `005_llm_as_a_judge` — parsed by generate_tutorial.py."""

TUTORIAL_METADATA = {
    "framework": "`slime`",
    "cluster_shape": "1 × 1×H100",
    "summary": "LLM-as-a-judge reward for haiku training — deploy a judge model, score quality alongside structure",
