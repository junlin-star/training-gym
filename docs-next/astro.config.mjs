          ...
          items: [
            ...
            { label: 'CLI Reference', link: '/reference/cli/' },
            {
              ...
              items: [
                ...
                { label: 'Sample', link: '/reference/core/sample/' },
                { label: 'MultimodalDataset', link: '/reference/core/multimodaldataset/' },
                { label: 'extract_code', link: '/reference/core/extract_code/' },
                { label: 'score_in_sandbox', link: '/reference/core/score_in_sandbox/' },
              ],
            },
            {
              label: 'Models',
              items: [
                ...
                { label: 'Qwen3-VL-8B', link: '/reference/models/qwen3_vl_8b/' },
                { label: 'Qwen3-ASR-1.7B', link: '/reference/models/qwen3_asr_1_7b/' },
              ],
            },
            {
              label: 'Training',
              items: [
                ...
                { label: 'TrainingGroup', link: '/reference/training/traininggroup/' },
                ...
                { label: 'Qwen3_VL_8b_Recipe', link: '/reference/training/qwen3_vl_8b_recipe/' },
                { label: 'Qwen3_ASR_1_7b_Recipe', link: '/reference/training/qwen3_asr_1_7b_recipe/' },
                { label: 'list_checkpoints', link: '/reference/training/list_checkpoints/' },
                { label: 'convert_checkpoint_to_hf', link: '/reference/training/convert_checkpoint_to_hf/' },
              ],
            },
            {
              label: 'Endpoints',
              items: [
                { label: 'ensure_endpoint', link: '/reference/endpoints/ensure_endpoint/' },
                { label: 'endpoint_chat', link: '/reference/endpoints/endpoint_chat/' },
                { label: 'endpoint_chat_message', link: '/reference/endpoints/endpoint_chat_message/' },
                { label: 'wait_for_server_url', link: '/reference/endpoints/wait_for_server_url/' },
              ],
            },
          ],
        },
