...
_EXPORTS = {
    ...
    "HarborEvalGenerateFn": ("modal_training_gym.common.eval", "HarborEvalGenerateFn"),
    "HarborEvalGenerationContext": (
        "modal_training_gym.common.eval",
        "HarborEvalGenerationContext",
    ),
    "HarborEvalRunFn": ("modal_training_gym.common.eval", "HarborEvalRunFn"),
    "HarborEvalScoreFn": ("modal_training_gym.common.eval", "HarborEvalScoreFn"),
    "HarborEvalScoringContext": (
        "modal_training_gym.common.eval",
        "HarborEvalScoringContext",
    ),
